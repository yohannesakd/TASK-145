...
- direct view-model coverage exists, including:
...
- confidence is high that the current test suite is broad and current because the test tree now includes `AppBootstrapTest`, fragment UI tests, DAO tests, view-model tests, and `UiJourneyTest`
